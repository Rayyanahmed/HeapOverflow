...
;
(function() { this.JST || (this.JST = {}); this.JST["answers/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<form>\n\t<label for="answer_content">Content</label>\n\t<input type="hidden" name="answer[question_id]" value="',  question.escape('id') ,'">\n\t<input type="text" name="answer[content]" id="answer_content"><br>\n\t<input type="submit" class="answer-form">\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["answers/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="answer-vote">\n\tVote: ',  answer.get('vote_count') ,'\n</div>\n<li class="answer-show-container">\n\t',  answer.escape('content') ,'\n\t<button class="destroy-answer">Destroy</button>\n\t<ul class="answer-comments"></ul>\n\t<div class="comment-form"></div>\n</li>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["comments/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<form>\n\t<label for="comment_body">Comment</label>\n\t<input type="hidden" name="comment[answer_id]" value="',  answer.escape('id') ,'">\n\t<input type="text" name="comment[body]" id="comment_body"><br>\n\t<input type="submit" class="comment-form">\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["comments/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('',  comment.escape("body") ,'\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["questions/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<form>\n\t<label for="question_title">Title</label>\n\t<input type="text" name="question[title]" id="question_title"><br>\n\t<label for="question_content">Content</label>\n\t<input type="text" name="question[content]" id="question_content"><br>\n\t<label for="question_tag_list">Tags:</label>\n\t<input type="text" name="question[tag_list]" id="question_tag_list">\n\t<input type="submit">\n</form>\n<a href="#">Back to questions</a>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["questions/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="questions-index">\n\t<div class="questions-container">\n\t\t<div class="all-questions">All Questions\n\t\t\t<ul class="sort-questions">\n\t\t\t\t<li class="most-answered">most-answered</li>\n\t\t\t\t<li class="votes">votes</li>\n\t\t\t\t<li class="frequent">frequent</li>\n\t\t\t\t<li class="newest">newest</li>\n\t\t\t</ul>\n\t\t</div>\n\t\t<ul class="questions"></ul>\n\t</div>\n\t<div class="tags-container">\n\t\t<div class="questions-stats-header">15,722<span class="questions-stats-header-text">questions</span></div>\n\t\t<div class="hot-questions">\n\t\t\t<span class="header">Hot Questions!</span>\n\t\t\t<li class="hot-question-item"></div>\n\t\t</div>\n\t</div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["questions/index_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<li class="question-item-container">\n\t<a href="#/questions/',  question.get('id') ,'">\n\t<ul class="question-stats">\n\t\t<li class="votes-container"><div class="vote-stat">',  question.get('vote_count') ,'</div><span class="vote-stats-text">votes</span></li>\n\t\t<li class="answers-container"><div class="answer-stat">',  question.get('answer_count') ,'</div><span class="answer-stats-text">answers</span></li>\n\t\t<li class="views-container"><div class="view-stat">',  question.get('views') ,'</div><span class="view-stats-text">views</span></li>\n\t</ul>\n\t<div class="question-title">\n\t\t',  question.escape('title') ,'\n\t</div>\n\t<div class="question-content">\n\t\t',  question.escape('content').slice(0, 200) ,'\n\t</div>\n\n\t<ul class="question-tags"></ul>\n\n\t<ul class="author-info">\n\n\t\t<li class="time-posted">Asked: <abbr class="timeago" title="',  question.escape('created_at') ,'"></abbr></li>\n\t\t<li class="author-username">',  question.escape('user') ,'</li>\n\t</ul>\n\t</a>\n</li>\n\n<script type="text/javascript">\n   jQuery(document).ready(function() {\n     $("abbr.timeago").timeago();\n   });\n</script>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["questions/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="question-show-container">\t\n\n\t<div class="question-show-title">\t\n\t\t',  question.escape('title') ,'<br>\n\t</div>\n\n\t<div class="voting">\n\t\t<div class="vote-count">Vote: ',  question.get('vote_count') ,'</div>\n\t</div>\n\n\t<div class="question-show-left">\n\n\t\t<div class="question-show-content">\n\t\t\t',  question.escape('content') ,'<br>\n\t\t</div>\n\n\t\t<div class="question-show-answers-container">\n\t\t\t<span class="answer-count">',  question.answers().length ,' Answers</span>\n\t\t\t<ul class="question-show-answers"></ul>\n\t\t</div>\n\n\t\t<div class="answer-form"></div>\n\n\t</div>\n\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["tags/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('Tags\n\n<ul class="all-tags">\n</ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["tags/index_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<a href="#/tags/',  tag.escape('id') ,'">',  tag.escape('name') ,'</a>\n\n\n\t\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["tags/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="questions-index">\n\t<div class="questions-container">\n\t\t<div class="all-questions">',  tag.escape('name') ,'\n\t\t</div>\n\t\t<ul class="questions"></ul>\n\t</div>\n\t<div class="tags-container">\n\t\t<div class="questions-stats-header">15,722<span class="questions-stats-header-text">questions</span></div>\n\t\t<div class="hot-questions">\n\t\t\t<span class="header">Hot Questions!</span>\n\t\t\t<li class="hot-question-item"></div>\n\t\t</div>\n\t</div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["votes/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<button class="upvote">Upvote</button>\n<div class="vote-count"></div>\n<button class="downvote">Downvote</button>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["votes/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('',  vote.get('count') ,'\n');}return __p.join('');};
}).call(this);
...
;
HeapOverflow.Models.Comment = Backbone.Model.extend({
...
;
HeapOverflow.Models.User = Backbone.Model.extend({
	urlRoot: '/api/users'
})
;
HeapOverflow.Models.Vote = Backbone.Model.extend({
	urlRoot: "/api/votes"
})
;
HeapOverflow.Collections.Answers = Backbone.Collection.extend({
	url: '/api/answers',
	model: HeapOverflow.Models.Answer 
})
;
...
HeapOverflow.Collections.Tags = Backbone.Collection.extend({
	url: '/api/tags',
	...
	getOrFetch: function(id) {
		...
		var tag = new HeapOverflow.Models.Tag({id: id});
		tag.fetch({
			success: function() {
				this.add(tag);
			}.bind(this)
...
;
HeapOverflow.Collections.Votes = Backbone.Collection.extend({
	url: '/api/votes',
	model: HeapOverflow.Models.Vote
});
...
;
HeapOverflow.Views.CommentShow = Backbone.View.extend({
...
;
HeapOverflow.Views.VoteForm = Backbone.View.extend({
  template: JST["votes/form"],
  tagName: "form",
  className: "vote",
  ...
  render: function() {
    ...
    this.$el.html(content);
    var voteShow = new HeapOverflow.Views.VoteShow({model: this.model});
